...
class UserManager(BaseUserManager):
    def create_user(self, email, first_name, last_name, phone_number, birth_date, password=None, is_active=True, is_staff=False, is_admin=False):
        if not email:
    ...
    def create_staffuser(self, email, first_name, last_name, phone_number, birth_date, password=None):
        user = self.create_user(email, first_name=first_name, last_name=last_name,
                                phone_number=phone_number, birth_date=birth_date, password=password, is_staff=True)
        return user

    def create_superuser(self, email, first_name, last_name, phone_number, birth_date, password=None):
        user = self.create_user(email, first_name=first_name, last_name=last_name,
                                phone_number=phone_number, birth_date=birth_date, password=password, is_staff=True, is_admin=True)
        return user
